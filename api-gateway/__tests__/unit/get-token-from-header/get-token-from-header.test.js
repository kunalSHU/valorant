...
describe("Can retrieve a token from an authorization header in the correct 'Bearer <Token>' format", () => {
...
describe('Can handle invalid authorization header formats', () => {
...
describe('Can handle non-string authorization header formats', () => {
